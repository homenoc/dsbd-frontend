  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route
          path="/dashboard/add/connection"
          element={<PrivateRoute children={<ConnectionAdd />} />}
        />
        ...
        />
        <Route path="/dashboard/feedback" element={<PrivateRoute children={<Feedback />} />} />
      </Routes>
    </BrowserRouter>
  );
}
